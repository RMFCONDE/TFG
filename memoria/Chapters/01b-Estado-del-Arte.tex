...
en un entorno de baja señal-ruido. Entre los métodos concretos, los
\textit{Random Forests} de \citet{Breiman2001} ofrecen un modelo no lineal
robusto basado en el promediado de árboles, mientras que las regresiones
regularizadas ---el \textit{Lasso}, el \textit{Ridge} y su combinación, la
\textit{elastic net} de \citet{Zou2005}--- proporcionan modelos parsimoniosos
con selección automática de variables. Todos ellos se emplean en este trabajo
para predecir la rentabilidad esperada que alimenta el optimizador.
...
---mediante \textit{shrinkage} y modelos de factores \cite{Ledoit2004,
FamaFrench1993}--- como en la rentabilidad esperada ---mediante aprendizaje
automático \cite{Gu2020}---; y la evaluación honesta del rendimiento fuera de
...
% NOTA PARA RICARDO: si el director confirma que debes citar y diferenciar el
% TFG previo de la universidad con tema similar, añade aquí su referencia real
% (autor, título, año) y un párrafo señalando en qué se diferencia este trabajo.
