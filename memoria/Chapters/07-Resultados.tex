...
\begin{table}[htbp]
    ...
    \input{../data/outputs/tabla_resultados}
\end{table}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.60\textwidth]{../data/outputs/sharpe_comparacion}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.70\textwidth]{../data/outputs/valor_acumulado}
...
sino una \textbf{infraperformance sistemática}: los activos seleccionados
por el optimizador tienden a tener rentabilidades out-of-sample inferiores
a las del mercado.
...
concentración (HHI $0{,}15$; $8{,}8$ activos). \textbf{Ledoit-Wolf} lo mejora en
...
\textbf{Ridge} (Sharpe $0{,}68$) iguala al baseline clásico y logra el
\textbf{menor drawdown del estudio} ($18{,}4\%$); \textbf{Lasso} ($0{,}75$) es
la \textbf{mejor cartera optimizada}, prácticamente igual a la $1/N$, con el
menor turnover ($0{,}12$) y la mayor diversificación (14,9 activos, HHI
$0{,}10$); y \textbf{Random Forest} ($0{,}71$) es competitiva y la mejor de las
no lineales, con turnover moderado ($0{,}36$).
...
constante: el modelo reconoce la ausencia de señal explotable, un resultado
honesto en sí mismo. Todo ello es coherente con la literatura \cite{Gu2020}, que
...
notablemente: las estrategias con $\boldsymbol{\mu}$ histórico rotan un
$0{,}13$--$0{,}14$, frente al $0{,}12$ de Lasso, el $0{,}36$ de RF y el
$0{,}57$ de Ridge.

Frente al resultado habitual de que el ML dispara la rotación de la cartera,
aquí el modelo más parsimonioso (Lasso) alcanza un turnover incluso
...
optimizadas siguen trayectorias similares hasta ~2018, cuando el SPY se despega,
...
\begin{table}[htbp]
    ...
    \input{../data/outputs/tabla_significancia}
\end{table}
