...
\begin{table}[htbp]
    ...
    \resizebox{\textwidth}{!}{\input{../data/outputs/tabla_resultados}}
\end{table}
...
\begin{table}[htbp]
    \centering
    \caption{Significación estadística de los ratios de Sharpe: intervalo de
...
de significación estadística, esa mejora no puede darse por establecida con los
